...
type BazServiceClient interface {
	MethodName(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*external.FooResponse, error)
}
...
func (c *bazServiceClient) MethodName(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*external.FooResponse, error) {
	out := new(external.FooResponse)
...
type BazServiceServer interface {
	MethodName(context.Context, *emptypb.Empty) (*external.FooResponse, error)
...
func (UnimplementedBazServiceServer) MethodName(context.Context, *emptypb.Empty) (*external.FooResponse, error) {
