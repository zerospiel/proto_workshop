...
//go:generate protoc --proto_path nested:third_party --go_opt=paths=source_relative,Mk8s.io/apimachinery/pkg/runtime/generated.proto=k8s.io/apimachinery/pkg/runtime --go_out=generated ./nested/example_imports.proto
package imports
